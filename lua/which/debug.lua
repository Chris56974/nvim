...
require("which-key").register({
  ...
  [","] = { "<cmd>lua require('dap').toggle_breakpoint()<CR>", "Create breakpoint" },
  ...
  f = { "local widgets=require('dap.ui.widgets');widgets.centered_float(widgets.scopes)<CR>", "Float dap ui widgets" },
  ...
  h = { "<cmd>lua require('dap.ui.variables').hover()<CR>", "Hover dap ui variables" },
  v = { "<cmd>lua require('dap.ui.variables').visual_hover()<CR>", "Visual Hover dap ui" },
  s = { "<cmd>lua require('dap').scopes()<CR>", "Dap Scopes" },
  u = { ":lua require('dapui').toggle()<CR>", "Toggle dapUI" },
  w = { "<cmd>lua require('dap.ui.widgets').hover()<CR>", "Hover dap ui widgets" },
