...
_G.packer_plugins = {
  ...
  ["lf.vim"] = {
    ...
    loaded = true,
    path = "/home/cj/.local/share/nvim/site/pack/packer/start/lf.vim",
  ...
  ["vim-floaterm"] = {
    loaded = true,
    path = "/home/cj/.local/share/nvim/site/pack/packer/start/vim-floaterm",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-colorizer.lua', 'lightspeed.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
